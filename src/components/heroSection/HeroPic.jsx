...
const HeroPic = () => {
  return (
    ...
    >
      {/* Hexagon Backgrounds */}
      <div className="absolute z-0 animate-spin-slow pointer-events-none">
      ...
      <img
        ...
        alt="SK"
        className="relative z-10 w-[280px] h-[280px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] object-cover rounded-full shadow-xl clip-[polygon(25%_6.7%,75%_6.7%,100%_50%,75%_93.3%,25%_93.3%,0%_50%)]"
      />
    </motion.div>
  );
};
